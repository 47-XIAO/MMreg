...
def main():
    ...
    batch_size = 2
    train_dir = '/hy-tmp/xsq/AbdomenMRCT_exp/imagesTr_norm/'
    val_dir = '/hy-tmp/xsq/AbdomenMRCT_exp/imagesTs_norm/'

    weights = [1, 1]  # loss weights
    lr = 1e-4
    save_dir = 'PRC_mind_{}_reg_{}_lr_{}_Abdomen_contl_40e/'.format(*weights, lr)
    ...
    train_set = datasets.CTMRIABDDataset(train_dir, transforms=train_composed)
    val_set = datasets.CTMRIABDInferDataset(val_dir, transforms=val_composed)
    ...
    for epoch in range(epoch_start, max_epoch + 1):
        ...
        }, save_dir='/hy-tmp/experiments/' + save_dir, filename='dsc{:.3f}.pth.tar'.format(eval_dsc.avg))
        loss_all.reset()
